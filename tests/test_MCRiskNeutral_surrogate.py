...
surrogate = MCRiskNeutral(kernel, p, num_points_MC=num_points_MC)
...
plt.plot(Xtest,ftest,linewidth=3,color='orange',label='Monte Carlo Risk Neutral')
...
plt.title('Monte Carlo Risk Neutral')
plt.legend()
plt.show()
